...
export const getLessonsByCourseSlug = async (req, res) => {
    try {
...
export const createCourse = async (req, res) => {
    try {
        const { title, author, category, description, level, status, thumbnail, highlights, isFeatured, image_author, slogan, } = req.body;
...
export const DeletedCourses = async (req, res) => {
    try {
        const { id } = req.params;
