...
import { getAllCourses, createCourse, getCourseDetail, UpdateCourse, getFeaturedCourses, getLessonsByCourseSlug, registerCourse, searchCourse, DeletedCourses, } from "../controllers/course.control.js";
const router = Router();
